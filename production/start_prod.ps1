...
$env:ALLOWED_ORIGINS = if ($env:ALLOWED_ORIGINS) { $env:ALLOWED_ORIGINS } else {
    "https://eligetuplan.cl,https://www.eligetuplan.cl"
}
...
Write-Host "[2/2] Starting Cloudflare Tunnel for api.eligetuplan.cl..." -ForegroundColor Green

...
| Dato observado | Valor aproximado |
| --- | --- |
| Valor base mínimo | 0,94 UF |
| Valor base mediano | 2,70 UF |
| Valor base máximo | 8,25 UF |
| GES observado | entre 0,71 y 1,04 UF |
...
Para ver precios actualizados y comparables, lo mejor es usar el [comparador de planes de Isapre](/comparar/isapres).
...
Si quieres entender este cálculo paso a paso, revisa la guía: [qué es el 7% de salud y cómo saber si te alcanza para una Isapre](/blog/que-es-7-por-ciento-salud-isapre).
...
| Plan barato con baja cobertura | Puede salir caro si usas clínicas o prestaciones fuera de su mejor red |
| Plan más caro con mejor red | Puede convenir si usas frecuentemente esa clínica o tienes más riesgo médico |
...
Puedes partir en el [comparador de Isapres](/comparar/isapres), filtrar por precio, revisar coberturas y mirar planes por Isapre.
...
- [Superintendencia de Salud — Cotizaciones de salud](https://www.superdesalud.gob.cl/tax-materias-isapres/cotizaciones-de-salud-3465/)
...
- Datos observados en la caché local de planes de EligeTuPlan en test: `test/backend/.cache/tu7_planes.json`, revisión del 17 de junio de 2026.

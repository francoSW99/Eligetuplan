...
// ── Isapres section (logos full color, not faded; mini cards) ──────────
function IsapresSection() {
  const D = window.SITE_DATA;
  // Duplicate for smooth marquee
  const marquee = [...D.isapres, ...D.isapres];
  return (
    <section id="comparar" className="bg-paper py-20 md:py-24 relative overflow-hidden" data-comment-anchor="bad3b69f04-section-13-5">
      <div className="mx-auto max-w-[1280px] px-6 lg:px-10">
        <header className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="text-[clamp(28px,3.8vw,40px)] font-extrabold text-teal tracking-[-0.02em] leading-[1.1] mb-3 text-balance">
            Comparamos a todas. <span className="serif italic text-mint-text font-medium">Sin excepciones.</span>
          </h2>
          <p className="text-[15px] text-ink-soft leading-relaxed">
            Cada logo es un partner real con planes actualizados. Haz click para filtrar el catálogo por Isapre.
          </p>
        </header>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3">
          ...
          <a
            ...
            className="group flex flex-col items-center justify-center gap-3 p-5 rounded-2xl bg-white border border-teal/8 hover:border-mint/40 hover:shadow-[0_14px_30px_-12px_rgba(15,81,75,0.18)] hover:-translate-y-1 transition-all no-underline"
            title={`${i.name} · ${i.planCount} planes`}>
              ...
              <div className="text-center">
                <div className="text-[10.5px] font-bold tracking-[0.06em] uppercase text-teal/55">
                  {i.planCount} planes
                </div>
              </div>
            </a>
        ...
        <div className="mt-10 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 text-[14px] font-bold text-teal hover:text-mint-text transition-colors no-underline">
            
            Ver el catálogo completo de 1.854 planes
